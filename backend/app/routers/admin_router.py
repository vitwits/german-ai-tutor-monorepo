...
async def caching_stats(
    ...
    """TTS Caching Statistics for Vocabulary (translations only)"""
    # Читаємо єдиний агрегований рядок TTSLog
    result = await db.execute(select(TTSLog))
    log_entry = result.scalar_one_or_none()
    
    # Якщо немає даних, використовуємо нулі
    if not log_entry:
        stats_map = {
            "de": {"api_req": 0, "api_chars": 0, "cache_req": 0, "cache_chars": 0},
            "en": {"api_req": 0, "api_chars": 0, "cache_req": 0, "cache_chars": 0},
            "uk": {"api_req": 0, "api_chars": 0, "cache_req": 0, "cache_chars": 0}
        }
    else:
        # Виймаємо значення з агрегованих полів
        stats_map = {
            "de": {
                "api_req": log_entry.de_api_requests or 0,
                "api_chars": log_entry.de_api_chars or 0,
                "cache_req": log_entry.de_cache_requests or 0,
                "cache_chars": log_entry.de_cache_chars or 0
            },
            "en": {
                "api_req": log_entry.en_api_requests or 0,
                "api_chars": log_entry.en_api_chars or 0,
                "cache_req": log_entry.en_cache_requests or 0,
                "cache_chars": log_entry.en_cache_chars or 0
            },
            "uk": {
                "api_req": log_entry.uk_api_requests or 0,
                "api_chars": log_entry.uk_api_chars or 0,
                "cache_req": log_entry.uk_cache_requests or 0,
                "cache_chars": log_entry.uk_cache_chars or 0
            }
        }
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center;">Google TTS (API)<br><small style="font-weight: normal; color: #999;">Requests (Characters)</small></th>
                            <th style="text-align: center;">Cached<br><small style="font-weight: normal; color: #999;">Requests (Characters)</small></th>
                            <th style="text-align: center;">Total<br><small style="font-weight: normal; color: #999;">Requests (Characters)</small></th>
