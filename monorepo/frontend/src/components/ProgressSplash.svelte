<script>
  ...
  const getMessages = (level) => ({
    ukr: [
      ...
      `Підбираю лексику рівня ${level}...`,
      "Будую ідеальні німецькі речення...",
      "Створюю цікавий квіз...",
      "Озвучую німецьку вимову...",
      "Майже готово! Приємного навчання!"
    ],
    eng: [
      "Analyzing your selected topic...",
      `Selecting ${level}-level vocabulary...`,
      "Building perfect German sentences...",
